...
> 将构建智能体化系统比作「画布」的隐喻，与我们在 Google Vertex AI 平台上的工作高度契合。
> 我们致力于为开发者提供最强大、最灵活的“画布”，以构建下一代 AI 应用。
> 本书提供扎实而贴近实践的指引，帮助开发者充分释放这一“画布”的潜力；
> 从提示链、工具使用到智能体间协作、自校正、安全与护栏，本书为希望构建复杂 智能体的开发者提供了全面的工具箱。
...
> AI 的未来将由能够构建这些智能系统的开发者的创造力与巧思所塑造。
> 《Agentic Design Patterns》是释放这种创造力不可或缺的重要资源；
> 它提供必要的知识与实例，不仅帮助理解智能体化系统的「是什么」与「为什么」，还有「如何做」。
...
> 我很高兴看到这本书走进开发者社区。
> 书中的模式与原则无疑将加速创新且影响深远的 AI 应用的发展，并在未来多年持续塑造我们的世界。

Saurabh Tiwary
VP & General Manager, CloudAI @ Google

> Saurabh Tiwary
> Google Cloud AI 副总裁兼总经理
